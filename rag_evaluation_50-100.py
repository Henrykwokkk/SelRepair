...
with open ("./Tufano_dataset/50-100/src_source_code_unixAST_embedding_test_remaining_retrival.json",'r') as f1, open(
    "./Tufano_dataset/50-100/tgt-test_remaining.txt",'r') as f2,open(
        './Tufano_dataset/50-100/src_source_code_unixAST_embedding_1000_codebase.json','r') as f3,open(
            './Tufano_dataset/50-100/tgt_1000_codebase.txt','r') as f4:
